...
Public Class FrmOutputType
    Private Sub FrmOutputType_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub readyGrid()
        ...
        Dim fldOutputCode As New GridViewTextBoxColumn("OUTPUT CODE")
        fldOutputCode.FieldName = "fldOutputCode"
        fldOutputCode.Width = 120
        gvData.Columns.Add(fldOutputCode)

        Dim fldOutputName As New GridViewTextBoxColumn("OUTPUT NAME")
        fldOutputName.FieldName = "fldOutputName"
        fldOutputName.Width = 240
    ...
    Private Sub bwLoadData_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwLoadData.DoWork
        myData = Slipknot.dbSelect("SP_SelectAllOutputType")
    End Sub
    ...
    Private Sub FrmOutputType_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        bwLoadData.RunWorkerAsync()
    End Sub
    ...
    Private Sub cbbAdd_Click(sender As Object, e As EventArgs) Handles cbbAdd.Click
        ...
        If txtName.Text.TrimStart.TrimEnd = String.Empty Then
            RadMessageBox.Show("Name cannot be empty", "WARNING", MessageBoxButtons.OK, RadMessageIcon.Exclamation)
        ...
        If Slipknot.dbAED("SP_InsertOutputType") Then
            txtCode.Clear()
            txtName.Clear()
    ...
    Private Sub bwDelete_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwDelete.DoWork
        ...
        Slipknot.dbAED("SP_DeleteOutputType")
    End Sub

    Private Sub cbbDelete_Click(sender As Object, e As EventArgs) Handles cbbDelete.Click
        Dim check As String = Slipknot.checkPermission(currentUser.Item("fldUsername"), "fldMROutputType")
