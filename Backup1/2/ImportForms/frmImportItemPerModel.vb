...
Public Class frmImportItemPerModel
    ...
    Private Sub readyGrid()
        ...
        fldModelCode.Width = 130
        fldModelCode.IsVisible = False
        ...
        Try
            ...
            Dim joinResult As IEnumerable = (From T0 In table.AsEnumerable()
                                             Select New With
                                             {
                                               ...
                                               .fldModelName = T0.Item(1),
                                               .fldModelCode = getModelCode(.fldModelName),
                                               .fldItemCodeOk = checkItemCode(.fldItemCode),
                                               .STATUS = checkNG(.fldItemCodeOk, .fldModelCode)
                                             }).ToList
    ...
    Function checkNG(ByVal itemCodeOk As Boolean, ByVal modelCode As String) As String

        If itemCodeOk = False Or modelCode = String.Empty Then
            Return "NG"
    ...
    Private Sub gvData_CellFormatting(sender As Object, e As CellFormattingEventArgs) Handles gvData.CellFormatting
        ...
        Else
            ...
            If Convert.ToBoolean(e.CellElement.RowInfo.Cells("fldItemCodeOk").Value) = False And Convert.ToString(e.CellElement.RowInfo.Cells("fldModelCode").Value).TrimStart.TrimEnd = String.Empty Then
                e.CellElement.RowInfo.Cells("fldWarning").Value = "Item code not found in list, Model code not found in list"
            ...
            ElseIf Convert.ToString(e.CellElement.RowInfo.Cells("fldModelCode").Value).TrimStart.TrimEnd = String.Empty Then
                e.CellElement.RowInfo.Cells("fldWarning").Value = "Model code not found in list"
            Else
    ...
    Private Sub bwSave_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bwSave.DoWork
        ...
        For counter As Integer = 0 To gvData.Rows.Count
            ...
            If Convert.ToString(gvData.Rows(counter).Cells("STATUS").Value) <> "NG" Then
                ...
                Slipknot.addParameter("parModel", modelCode.TrimStart.TrimEnd)
