...
Public Class FrmSRCDailyReportViewer
    ...
    Dim Catherine As New DB("192.168.191.12", "dbReportServer", "feap", "45|iF$")
    ...
    Private Sub FrmSRCDailyReportViewer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If globalVariables.SRCReportType = "Daily Report Shift" Then
            ...
            If globalVariables.SRCReportSeparate = "STANDARD" Then
                ...
                If ModelName.Rows.Count >= 1 Then
                    ...
                    Me.ReportViewer1.ReportSource = report.GenerateReport("MIA/rptSRCDailyReport")
        ...
        ElseIf globalVariables.downtimeReportType = "STANDARD" Then
            ...
            If globalVariables.DowntimeType = "ASSY" Then
                ...
                Me.ReportViewer1.ReportSource = report.GenerateReport("MIA/rptSRCDowntimeReport")
                ReportViewer1.RefreshReport()


            ElseIf globalVariables.DowntimeType = "Welding" Then
                Me.ReportViewer1.ReportEngineConnection = Me.report.Connection
                Me.report.AddReportParameters("parID", globalVariables.AssyDownTimeID)
        ...
        ElseIf globalVariables.SRCReportType = "Welding Daily Report" Then
            ...
            'Dim mainReport As New MIA.rptPWDailyReportv2
            ...
            'Dim subWeldingLot1 = New Telerik.Reporting.InstanceReportSource
            'Dim subWeldingLot2 = New Telerik.Reporting.InstanceReportSource
            'Dim subWeldingLot3 = New Telerik.Reporting.InstanceReportSource
            'Dim subWeldingLot4 = New Telerik.Reporting.InstanceReportSource
            'Dim subWeldingLot5 = New Telerik.Reporting.InstanceReportSource
            'Dim subWeldingGood1 = New Telerik.Reporting.InstanceReportSource
            'Dim subWeldingGood2 = New Telerik.Reporting.InstanceReportSource


            'subWeldingLot1.Parameters.Add("parID", globalVariables.parDRID)
            'subWeldingLot1.Parameters.Add("parType", globalVariables.parType)
            'subWeldingLot1.Parameters.Add("parLot1", globalVariables.parLot1)

            'subWeldingLot2.Parameters.Add("parID", globalVariables.parDRID)
            'subWeldingLot2.Parameters.Add("parType", globalVariables.parType)
            'subWeldingLot2.Parameters.Add("parLot2", globalVariables.parLot2)

            'subWeldingLot3.Parameters.Add("parID", globalVariables.parDRID)
            'subWeldingLot3.Parameters.Add("parType", globalVariables.parType)
            'subWeldingLot3.Parameters.Add("parLot3", globalVariables.parLot3)


            'subWeldingLot4.Parameters.Add("parID", globalVariables.parDRID)
            'subWeldingLot4.Parameters.Add("parType", globalVariables.parType)
            'subWeldingLot4.Parameters.Add("parLot4", globalVariables.parLot4)


            'subWeldingLot5.Parameters.Add("parID", globalVariables.parDRID)
            'subWeldingLot5.Parameters.Add("parType", globalVariables.parType)
            'subWeldingLot5.Parameters.Add("parLot5", globalVariables.parLot5)


            'subWeldingGood1.Parameters.Add("parID", globalVariables.parDRID)
            'subWeldingGood1.Parameters.Add("parType", globalVariables.parType)
            'subWeldingGood1.Parameters.Add("parWeldingNo1", globalVariables.parWeldingNo1)


            'subWeldingGood2.Parameters.Add("parID", globalVariables.parDRID)
            'subWeldingGood2.Parameters.Add("parType", globalVariables.parType)
            'subWeldingGood2.Parameters.Add("parWeldingNo2", globalVariables.parWeldingNo2)
            ...
            If globalVariables.parType = "PW" Then
                ...
                'subWeldingLot1.ReportDocument = New MIA.rptSubPWWeldingLot1()
                'subWeldingLot2.ReportDocument = New MIA.rptSubPWWeldingLot2()
                'subWeldingLot3.ReportDocument = New MIA.rptSubPWWeldingLot3()
                'subWeldingLot4.ReportDocument = New MIA.rptSubPWWeldingLot4()
                'subWeldingLot5.ReportDocument = New MIA.rptSubPWWeldingLot5()
                'subWeldingGood1.ReportDocument = New MIA.rptSubWeldingGoodQty1()
                'subWeldingGood2.ReportDocument = New MIA.rptSubWeldingGoodQty2()
            ElseIf globalVariables.parType = "FW" Then
                instanceReportSource.ReportDocument = New MIA.rptPWDailyReportv2()
            End If
        ...
        ElseIf globalVariables.SRCReportType = "Auto Taping" Then
            ...
            Me.report.AddReportParameters("parDate", Mio.ReportATDate)
