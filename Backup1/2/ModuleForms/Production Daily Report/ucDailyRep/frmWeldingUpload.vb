...
Public Class FrmWeldingUpload
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        OpenProgress = OpenProgress + 16.5
        ...
        'gvOtherDetails.Columns.Add(fldID)

        'Dim fldDRID As New GridViewTextBoxColumn
        'fldDRID.HeaderText = "DRID"
        'fldDRID.FieldName = "fldDRID"
        'fldDRID.TextAlignment = ContentAlignment.MiddleCenter
        'fldDRID.Width = 150
        'fldDRID.IsVisible = False
        'gvOtherDetails.Columns.Add(fldDRID)

        'Dim fldOtherDetails As New GridViewTextBoxColumn
        'fldOtherDetails.HeaderText = "Other Details"
        'fldOtherDetails.FieldName = "fldOtherDetails"
        'fldOtherDetails.TextAlignment = ContentAlignment.MiddleCenter
        'fldOtherDetails.Width = 150
        'gvOtherDetails.Columns.Add(fldOtherDetails)
        ''dtOtherDetails = Maria.MyQuery("SELECT * FROM tblDailyReportWeldingOtherDetails WHERE fldDRID='" & globalVariables.DailyRepID & "'")
        gvOtherDetails.BestFitColumns()
    ...
    Private Sub BackgroundWorker2_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker2.DoWork
        ...
        While Manpowerint <= gvDataManpower.Rows.Count - 1
            ...
            Threading.Thread.Sleep(80)
            Dim Bruh As Decimal = 16.5 / gvDataManpower.Rows.Count
        ...
        While GoodQtyint <= gvGQ.Rows.Count - 1
            ...
            Threading.Thread.Sleep(80)
            Dim Bruh As Decimal = 16.5 / gvGQ.Rows.Count
        ...
        For rowcounter As Integer = 0 To Me.gvHourly.Rows.Count - 1
            ...
            Threading.Thread.Sleep(80)
            Dim Bruh As Decimal = 16.5 / gvHourly.Rows.Count
        ...
        If globalVariables.SRCReportType = "FW" Then
            ...
            For rowcounter As Integer = 0 To Me.gvDefect.Rows.Count - 1
                ...
                Threading.Thread.Sleep(80)
                Dim Bruh As Decimal = 16.5 / gvDefect.Rows.Count
        ...
        Else
            ...
            For rowcounter As Integer = 1 To Me.gvDefect.Rows.Count - 1
        ...
        For rowcounter As Integer = 0 To Me.gvOtherDetails.Rows.Count - 1
            ...
            Next
            Threading.Thread.Sleep(80)
            Dim Bruh As Decimal = 16.5 / gvOtherDetails.Rows.Count
        ...
        For rowcounter As Integer = 0 To Me.gvLot.Rows.Count - 1
            ...
            Threading.Thread.Sleep(80)
            Dim Bruh As Decimal = 16.5 / gvLot.Rows.Count
