...
Public Class FrmMachineList
    ...
    Private Sub FrmMachineList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub readyGrid()
        ...
        Dim fldMachineName As New GridViewTextBoxColumn("MACHINE NAME")
        fldMachineName.FieldName = "fldMachineName"
        fldMachineName.Width = 160
        gvData.Columns.Add(fldMachineName)
    ...
    Private Sub bwLoadData_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bwLoadData.DoWork
        ...
        myData = Slipknot.dbSelect("SP_SelectAllMachines")
    ...
    Private Sub FrmMachineList_Shown(sender As Object, e As EventArgs) Handles Me.Shown
    ...
    Private Sub cbbAddRecord_Click(sender As Object, e As EventArgs) Handles cbbAddRecord.Click
        Dim check As String = Slipknot.checkPermission(currentUser.Item("fldUsername"), "fldMRMachineList")
        ...
        If check = "RW" Then
            ...
            If txtMachineName.Text.TrimEnd.TrimStart = String.Empty Then
                RadMessageBox.Show("Machine name cannot be empty", "WARNING", MessageBoxButtons.OK, RadMessageIcon.Exclamation)
                Exit Sub
            End If

            Slipknot.addParameter("parCode", txtCode.Text.TrimStart.TrimStart)
            Slipknot.addParameter("parMachineName", txtMachineName.Text.TrimStart.TrimStart)
            Slipknot.addParameter("parAddedBy", currentUser.Item("fldUsername"))

            If Slipknot.dbAED("SP_InsertMachine") Then
                txtCode.Clear()
    ...
    Private Sub bwDelete_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwDelete.DoWork
        ...
        Slipknot.dbAED("SP_DeleteMachine")
