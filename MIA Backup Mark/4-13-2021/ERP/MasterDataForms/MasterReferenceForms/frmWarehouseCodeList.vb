...
Public Class frmWarehouseCodeList
    Private Sub frmWarehouseCodeList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub bwLoadData_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bwLoadData.DoWork
        ...
        myData = Slipknot.dbSelect("SP_SelectAllWarehouseCode")
    ...
    Private Sub frmWarehouseCodeList_Shown(sender As Object, e As EventArgs) Handles Me.Shown
    ...
    Private Sub cbbAdd_Click(sender As Object, e As EventArgs) Handles cbbAdd.Click
        ...
        Dim check As String = Slipknot.checkPermission(currentUser.Item("fldUsername"), "fldMRWarehouseCodeList")
        ...
        If check = "RW" Then
            ...
            If txtDescription.Text.TrimStart.TrimEnd = String.Empty Then
                RadMessageBox.Show("Description should not be empty", "WARNING", MessageBoxButtons.OK, RadMessageIcon.Exclamation)

                Exit Sub
            End If


            Slipknot.addParameter("parCode", txtCode.Text.ToUpper.TrimStart.TrimEnd)
            Slipknot.addParameter("parDescription", txtDescription.Text.ToUpper.TrimStart.TrimEnd)
            Slipknot.addParameter("parAddedBy", currentUser.Item("fldUsername"))

            If Slipknot.dbAED("SP_InsertWarehouseCode") Then
    ...
    Private Sub bwDelete_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwDelete.DoWork
        ...
        Slipknot.dbAED("SP_DeleteWarehouseCode")
    End Sub
