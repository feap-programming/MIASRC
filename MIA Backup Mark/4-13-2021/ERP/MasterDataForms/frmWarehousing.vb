...
Public Class FrmWarehousing
    ...
    Private Sub FrmWarehousing_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub bwLoadData_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwLoadData.DoWork
        myData = Slipknot.dbSelect("SP_SelectAllWarehousing")
    End Sub
    ...
    Private Sub FrmWarehousing_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        bwLoadData.RunWorkerAsync()
    End Sub
    ...
    Private Sub cbbAdd_Click(sender As Object, e As EventArgs) Handles cbbAdd.Click
        ...
        Slipknot.addParameter("parWarehouseCode", mcbWarehouse.SelectedValue)
        Slipknot.addParameter("parAddedBy", currentUser.Item("fldUsername"))

        If Slipknot.dbAED("SP_InsertWarehousing") Then
            If bwLoadData.IsBusy = False Then
                bwLoadData.RunWorkerAsync()
            End If
        End If
    ...
    Private Sub bwDelete_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwDelete.DoWork
        ...
        Slipknot.dbAED("SP_DeleteWarehousing")
    End Sub
