...
Public Class KillSwitch
    ...
    Shared Function addProdOutputGroup(ByVal title As String, ByVal recDate As Date, ByVal subLeader As String, ByVal teamLeader As String, ByVal whseCode As String, ByVal line As String, ByVal PartName As String, ByVal ItemCode As String, ByVal Shift As String) As Boolean
        Dim success As Boolean = True
        Dim myCmd As New MySqlCommand
        Dim conn As New MySql.Data.MySqlClient.MySqlConnection(ConnString)
