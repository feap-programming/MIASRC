...
Module globalVariables
    ...
    Public ConnString As String = "server=192.168.191.22;uid=feap;pwd=45|iF$;Convert Zero Datetime=True;database=dbMIA;SslMode=None"
    'Public ConnString As String = "server=localhost;uid=root;pwd=password;Convert Zero Datetime=True;database=dbmia"
    Public ConnStringMH As String = "server=192.168.191.252;uid=feap;pwd=45|iF$;Convert Zero Datetime=True;database=dbManHour;SslMode=None"
    ...
    Public DailyReportDateZwei As DateTime
    Public TestDT As DataTable
    Public FWGroup As String
    Public FWGroupDt As String
    ...
    Public AssyDownTimeType As String
    ...
    Public parWeldingNo3 As String
    Public parWeldingNo4 As String
    Public parLot1 As String
    Public parLot2 As String
    Public parLot3 As String
    Public parLot4 As String
    Public parLot5 As String
    Public parLot6 As String
    Public parLot7 As String
    Public parLot8 As String
    Public parLot9 As String
    Public parGoodQty1 As Integer
    Public parGoodQty2 As Integer
    Public parGoodQty3 As Integer
    Public parGoodQty4 As Integer
    '--------- Welding<End>
