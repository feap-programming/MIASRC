...
Public Class FrmCopyToCTOA
    ...
    Private Sub cbCopyData_Click(sender As Object, e As EventArgs) Handles cbCopyData.Click
        ...
        If Not (Me.numYearFrom.Value = Me.numYearTo.Value AndAlso
            ...
            Me.dtCTOA = Me.myDB.SPSelect("SP_P_SelectAllModelSettings")
            Dim modelGroupRows As DataRow() = Me.dtCTOA.Select("fldYear = " & Me.numYearFrom.Value & " AND " &
            ...
            For rowCount As Integer = 0 To modelGroupRows.Count() - 1
                ...
                rowInfo.Cells("fldCT").Value = modelGroupRows(rowCount).Item("fldCT")
                rowInfo.Cells("fldOA").Value = modelGroupRows(rowCount).Item("fldOA")
