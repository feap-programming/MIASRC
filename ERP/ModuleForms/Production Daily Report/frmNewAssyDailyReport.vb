...
Public Class FrmNewAssyDailyReport
    ...
    Private Sub GetModels()
        ...
        Dim DTModel As DataTable = Maria.MyQuery("SELECT * FROM tblModelList order by fldModelName asc")
    ...
    Private Sub cbbAdd_Click(sender As Object, e As EventArgs) Handles cbbAdd.Click
        ...
        Else
            ...
            Else
                ...
                'End If
                Dim baseDate As DateTime = dpDate.Value

                Dim dateToBase As DateTime = baseDate
                Dim DateFrom As DateTime = tpFrom.Value
                Dim DateTo As DateTime = tpTo.Value

                Dim DTFrom As String = baseDate.ToString("yyyy-MM-dd") & " " & DateFrom.ToString("HH:mm:ss")

                If tpFrom.Value > tpTo.Value Or ddShift.SelectedIndex >= 3 Then
                    dateToBase = dateToBase.AddDays(1)
                End If

                Dim DTTo As String = dateToBase.ToString("yyyy-MM-dd") & " " & DateTo.ToString("HH:mm:ss")
    ...
    Private Sub cbbDailyReport_Click(sender As Object, e As EventArgs) Handles cbbDailyReport.Click
        ...
        Else
            globalVariables.assyStatus = "DELETE ROW"
            ...
            Else
                ...
                Mio.Type = "ASSY"
                Mio.AssyTimeFrom = Convert.ToDateTime(gvData.CurrentRow.Cells("fldTimeFrom").Value).ToString("HH:mm")
    ...
    Private Sub cbbDelete_Click(sender As Object, e As EventArgs) Handles cbbDelete.Click
        globalVariables.assyStatus = "DELETE RECORD SRC"
    ...
    Private Sub cbbReport_Click(sender As Object, e As EventArgs) Handles cbbReport.Click
        ...
        globalVariables.ModelCode = gvData.CurrentRow.Cells("fldCode").Value
        globalVariables.AssyShift = gvData.CurrentRow.Cells("fldShift").Value
