...
Public Class ucCTEditor
    ...
    Private Sub readyGridSec1()
        ...
        gvSection1.ShowRowHeaderColumn = False
        gvSection1.AllowRowResize = False
    ...
    Private Sub readyGridSec2()
        ...
        fldQty.Width = 50
        fldQty.ReadOnly = False
        fldQty.WrapText = True
        fldQty.ShowUpDownButtons = False
        fldQty.DecimalPlaces = 5
        ...
        gvSection2.ShowRowHeaderColumn = False
        gvSection2.AllowRowResize = False
    ...
    Private Sub readyGridSec3()
        ...
        gvSection3.ShowRowHeaderColumn = False
        gvSection3.AllowRowResize = False
    ...
    Private Sub readyGridSec4()
        ...
        Dim fldValue As New GridViewDecimalColumn("VALUE")
        ...
        gvSection4.Columns("fldValue").FormatString = "{0:N2}"
        ...
        gvSection4.ShowRowHeaderColumn = False
    ...
    Private Sub readyGridSec5()
        ...
        gvSection5.ShowRowHeaderColumn = False
    ...
    Private Sub gvSection1_CellEndEdit(sender As Object, e As GridViewCellEventArgs) Handles gvSection1.CellEndEdit
        ...
        Try
            ...
            gvSection1.CurrentRow.Cells("totalWeight").Value = (fldPartWeight + (fldRunnerWeight / fldCavity)) * (1 + fldLoss / 100)
            Dim fldTotalWeight As Double = Convert.ToDecimal(gvSection1.CurrentRow.Cells("totalWeight").Value)

            Dim fldUnitPrice As Double = Convert.ToDecimal(gvSection1.CurrentRow.Cells("fldUnitPrice").Value)

            gvSection1.CurrentRow.Cells("piecePrice").Value = (fldTotalWeight * fldUnitPrice) / 1000
            Dim fldPiecePrice As Double = Convert.ToDecimal(gvSection1.CurrentRow.Cells("piecePrice").Value)

            gvSection1.CurrentRow.Cells("scrapWeight").Value = fldRunnerWeight + (fldPartWeight + fldRunnerWeight) * fldLoss / 100
            Dim fldScrapWeight As Double = Convert.ToDecimal(gvSection1.CurrentRow.Cells("scrapWeight").Value)
            ...
            gvSection1.CurrentRow.Cells("scrapPrice").Value = fldScrapWeight * fldCollection * fldScrapUnitPrice / 1000 / fldCavity
            Dim fldScrapPrice As Double = Convert.ToDecimal(gvSection1.CurrentRow.Cells("scrapPrice").Value)

            gvSection1.CurrentRow.Cells("matCost").Value = fldPiecePrice - fldScrapPrice
            Dim fldMatCost As Double = Convert.ToDecimal(gvSection1.CurrentRow.Cells("matCost").Value)
            ...
            gvSection1.CurrentRow.Cells("mhCost").Value = fldCycleTime * fldMhHr / 3600 / fldCavity
            Dim fldMHCost As Double = Convert.ToDecimal(gvSection1.CurrentRow.Cells("mhCost").Value)

            Dim fldMTHr As Double = Convert.ToDecimal(gvSection1.CurrentRow.Cells("fldMTHr").Value)

            gvSection1.CurrentRow.Cells("mtCost").Value = fldCycleTime * fldMTHr / 3600 / fldCavity
            Dim fldMTCost As Double = Convert.ToDecimal(gvSection1.CurrentRow.Cells("mtCost").Value)

            gvSection1.CurrentRow.Cells("processingFee").Value = fldMHCost + fldMTCost
            Dim fldProcessingCost As Double = Convert.ToDecimal(gvSection1.CurrentRow.Cells("processingFee").Value)

            gvSection1.CurrentRow.Cells("directCost").Value = fldMatCost + fldProcessingCost
            Dim fldDirectCost As Double = Convert.ToDecimal(gvSection1.CurrentRow.Cells("directCost").Value)
    ...
    Private Sub gvSection3_CellFormatting(sender As Object, e As CellFormattingEventArgs) Handles gvSection3.CellFormatting
        ...
        If e.CellElement.ColumnInfo.FieldName = "MH" OrElse
    ...
    Private Sub gvSection2_CellFormatting(sender As Object, e As CellFormattingEventArgs) Handles gvSection2.CellFormatting
        ...
        'Else
        If e.CellElement.ColumnInfo.FieldName = "Price" Then
    ...
    Private Sub gvSection1_CellFormatting(sender As Object, e As CellFormattingEventArgs) Handles gvSection1.CellFormatting
        ...
        If e.CellElement.ColumnInfo.FieldName = "totalWeight" OrElse
