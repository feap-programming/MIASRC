...
Public Class frmImportRMPriceList
    ...
    Private Sub readyGrid()
        ...
        fldPrice.Width = 70
        fldPrice.ThousandsSeparator = True
        ...
        Dim fldStandardPrice As New GridViewDecimalColumn("Standard Price")
        fldStandardPrice.FieldName = "fldStandardPrice"
        fldStandardPrice.Width = 100
        fldStandardPrice.ThousandsSeparator = True
        gvData.Columns.Add(fldStandardPrice)
        gvData.Columns("fldStandardPrice").FormatString = "{0:N2}"
        ...
        Try
            ...
            Dim joinResult As IEnumerable = (From T0 In table.AsEnumerable()
                                             Select New With
                                             {
                                               ...
                                               .fldPrice = Convert.ToDecimal(T0.Item(1)),
                                               .fldCurrency = T0.Item(2),
                                               .fldStandardPrice = T0.Item(3),
    ...
    Function checkNG(ByVal itemCodeOk As Boolean) As String

        If itemCodeOk = False Then
            Return "NG"
    ...
    Private Sub bwSave_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bwSave.DoWork
        ...
        For counter As Integer = 0 To gvData.Rows.Count
            ...
            If Convert.ToString(gvData.Rows(counter).Cells("STATUS").Value) <> "NG" Then
                ...
                stdPrice = Convert.ToDecimal(gvData.Rows(counter).Cells("fldStandardPrice").Value)
                effectiveDate = Convert.ToDateTime(gvData.Rows(counter).Cells("fldEffectivityDate").Value)
                ...
                Slipknot.addParameter("parStandardPrice", stdPrice)
                Slipknot.addParameter("parEffectivityDate", effectiveDate)
                Slipknot.addParameter("parAddedBy", currentUser.Item("fldUsername"))

                If Slipknot.dbAED("SP_InsertRMPriceList") Then
                    lineStat = "OK"
                Else
                    lineStat = "NG"
                End If
