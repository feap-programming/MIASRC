...
Public Class FrmCustomerItemMaster
    Private Sub FrmCustomerItemMaster_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub bwLoadData_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bwLoadData.DoWork
        myData = Slipknot.dbSelect("SP_SelectAllItemMasterPerCustomer")
    End Sub
    ...
    Private Sub FrmCustomerItemMaster_Shown(sender As Object, e As EventArgs) Handles Me.Shown
    ...
    Private Sub bwOperation_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwOperation.DoWork
        ...
        For i As Integer = 0 To rows.Length - 1
            ...
            Slipknot.dbAED("SP_DeleteItemMasterPerCustomer")
    ...
    Private Sub cbbImportData_Click(sender As Object, e As EventArgs) Handles cbbImportData.Click
        ...
        If Slipknot.IsFormOpen(frmImportItemPerCustomer) Then
            frmImportItemPerCustomer.Focus()
        Else
            If BulletForMyValentine.isRW("fldMDItemPerCustomer") = False Then
                Slapshock.NoAccessToFunctionMessage()
            ...
            frmImportItemPerCustomer.Show(Me)
        End If
    ...
    Private Sub cbbEdit_Click(sender As Object, e As EventArgs) Handles cbbEdit.Click
        ...
        If gvData.SelectedRows.Count > 0 Then
            If Slipknot.IsFormOpen(FrmEditItemPerCustomer) Then
                FrmEditItemPerCustomer.Focus()
            Else
                FrmEditItemPerCustomer.txtId.Text = Convert.ToString(gvData.CurrentRow.Cells("fldId").Value)
                FrmEditItemPerCustomer.Show(Me)
            End If
        End If
