...
Public Class frmRMPriceList
    ...
    Private Sub readyGrid()
        ...
        Dim fldPrice As New GridViewDecimalColumn("Purchase Price")
        ...
        Dim fldStandardPrice As New GridViewDecimalColumn("Standard Cost")
    ...
    Private Sub loadItemMaster()
        ...
        Dim dtProduct As DataTable = Slipknot.dbSelectManual("SELECT fldItemCode, fldPartName FROM tblItemMasterData WHERE fldCategory = 'RM' ")
    ...
    Private Sub cbbAdd_Click(sender As Object, e As EventArgs) Handles cbbAdd.Click
        ...
        If BulletForMyValentine.isRW("fldMDRMPriceList") = False Then
        ...
        Slipknot.addParameter("parStandardPrice", seStandardCost.Value)
    ...
    Private Sub bwLoadData_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bwLoadData.DoWork
        myData = Slipknot.dbSelect("SP_SelectAllRMPRiceList")
    End Sub
    ...
    Private Sub bwOperation_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwOperation.DoWork
        ...
        Slipknot.dbAED("SP_DeleteRMPriceMaster")
    End Sub
    ...
    Private Sub cbbImport_Click(sender As Object, e As EventArgs) Handles cbbImport.Click
        ...
        If Slipknot.IsFormOpen(frmImportRMPriceList) Then
            frmImportRMPriceList.Focus()
        Else
            If BulletForMyValentine.isRW("fldMDRMPriceList") = False Then
                Slapshock.NoAccessToFunctionMessage()
