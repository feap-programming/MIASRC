...
Public Class FrmEditHourlyProdMnt
    ...
    Private Sub GetData()
        ...
        txtCheckby.Text = FrmHourlyProdMnt.gvData.CurrentRow.Cells("fldCheckby").Value.ToString
        txtRemarks.Text = FrmHourlyProdMnt.gvData.CurrentRow.Cells("fldRemarks").Value.ToString
