...
Public Class frmEditLineIssuance
    Private Sub frmEditLineIssuance_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub loadRecord()
        ...
        Dim dt As DataTable = Slipknot.dbSelect("SP_SelectLineIssuanceById")
        ...
        If dt.Rows.Count > 0 Then
            ...
            mcbLine.SelectedValue = Convert.ToString(dt.Rows(0).Item("fldTo"))
    ...
    Private Sub btnContinue_Click(sender As Object, e As EventArgs) Handles btnContinue.Click
        ...
        If mcbFrom.SelectedValue = mcbLine.SelectedValue Then
        ...
        Slipknot.addParameter("parTo", mcbLine.SelectedValue)
        ...
        If Slipknot.dbAED("SP_UpdateLineIssuance") Then
