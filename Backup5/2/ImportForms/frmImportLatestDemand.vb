...
Public Class FrmImportLatestDemand
    ...
    Private Sub FrmImportLatestDemand_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        Slipknot.changeTheme(Me)

        LoadCustomerDropDown(ddCustomerCode)

        dtDateIssued.Value = Today

        dtDateFrom.Value = Today
        dtDateTo.Value = Today
        ...
        If Not String.IsNullOrWhiteSpace(ddCustomerCode.Text) Then
            ...
            Try
                ...
                For Each row As DataRow In table.Rows
                    ...
                    rowInfo.Cells("fldDateIssued").Value = dtDateIssued.Value
    ...
    Private Sub bwUpload_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwUpload.DoWork
        ...
        For counter As Integer = 0 To gvData.Rows.Count - 1
            ...
            For noOfDays As UInteger = 0 To dateDiff.Days Step 7
                ...
                Slipknot.addParameter("parDateIssued", gvData.Rows(counter).Cells("fldDateIssued").Value)
                Slipknot.addParameter("parDateForecast", dateFrom.AddDays(noOfDays))
                ...
                If Slipknot.dbAED("SP_P_InsertLatestDemand") Then
                    linestat = "SAVING..."
                Else
                    linestat = "NG"
    ...
    Private Sub SetUpColumns(gridView As RadGridView, dateFrom As Date, dateTo As Date)
        ...
        gridView.Columns("fldDateIssued").FormatString = "{0:dd-MMM-yy}"
