...
Public Class FrmImportModelGroup
                                    ...
                                    Select New With
                                         {
                                           ...
                                           .fldGroupCode = Regex.Replace(Trim(T0.Item(3)), "\s+", " "),
                                           .fldModelName = Regex.Replace(Trim(T0.Item(4)), "\s+", " "),
                                           .fldPartName = Regex.Replace(Trim(T0.Item(5)), "\s+", " "),
                                           .fldCustomerName = Regex.Replace(Trim(T0.Item(6)), "\s+", " "),
                                           .fldLineNumber = IIf(Not String.IsNullOrEmpty(T0.Item(7)), T0.Item(7), 0),
                                           .fldPriority = IIf(Not String.IsNullOrEmpty(T0.Item(8)), T0.Item(8), 0)
                                         }).ToList
