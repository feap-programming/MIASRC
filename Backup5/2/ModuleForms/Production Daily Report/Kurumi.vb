    ...
    Public Class DB
        ...
        Private Function ConnectionString() As MySqlConnection
            Dim connection As MySqlConnection = New MySqlConnection With {
                .ConnectionString = String.Format("server={0};  user id={2}; pwd={3}; Convert Zero Datetime=True; database={1}; SslMode=None", Me.server, Me.database, Me.userID, Me.password)
            }
            Return connection
        End Function
