...
Public Class ucWeldingManpowerv3
    ...
    Private Sub SelectTimePartition()
        ...
        dtTimePartition = Maria.SPSelect("SP_SRCDailyReport_ReportWeldingTimePartitionv2")
    ...
    Private Sub gvTimePartition_CellClick(sender As Object, e As GridViewCellEventArgs)
