...
Imports Telerik.Reporting.Processing.Data.DataModeling
...
Public Module Tohka
    ...
    Public Function InsertSRCHourly(DRID As Integer, Time As String, CableG As Integer,
                                    StatorG As Integer, FinalProd As Integer, Rotator As String,
                                    Stator As String, SubStator As String, Sleeve As String,
    ...
    Public Function DeleteSrcTableByDRID(TableName As String, DRID As Integer) As String
        Try
            Furina.MyQuery("delete from " & TableName & " where fldDRID=" & DRID & " AND fldID > 0")
            Return "Good"
        Catch ex As Exception
            Return ex.Message
        End Try
    ...
    Public Function DeleteSrcLotByDRIDAndTime(TableName As String, DRID As Integer, time As String) As String
        Try
            Furina.MyQuery("delete from " & TableName & " where fldDRID=" & DRID & " and fldTime = " & time & "")
            Return "Good"
        Catch ex As Exception
            Return ex.Message
        End Try
    End Function
    Public Function DeleteSrcLotByDRID(DRID As Integer, time As String) As String
        Try
            Furina.AddMySqlParameters("parDRID", DRID)
            Furina.AddMySqlParameters("parTime", time)
            Furina.SPADE("SP_SRC_DeleteSrcLot")
            Return "Good"
        Catch ex As Exception
            Return ex.Message
        End Try
    ...
    Public Function DeleteATLotByDRID(DRID As Integer, lot As String, time As String) As String
        Try
            Furina.AddMySqlParameters("parDRID", DRID)
            Furina.AddMySqlParameters("parLot", lot)
            Furina.AddMySqlParameters("parTime", time)
            Furina.SPADE("SP_SRC_DeleteATLot")
            Return "Good"
        Catch ex As Exception
            Return ex.Message
        End Try
    ...
    Public Function InsertSRCAssyLineEff(DRID As Integer, TimePart As String, OpTime As Integer, Hotto As Integer, Plan As Integer, Unplan As Integer, Cycle As Double,
                                         ...
                                         GoodQty As Integer, Delivered As String, Replace As Integer, Scrap As Integer, Sample As String, TotalOpTime As Integer) As String
        ...
        Try
            ...
            Furina.AddMySqlParameters("parUser", CurrUser)
            Furina.AddMySqlParameters("parTotalOpTime", TotalOpTime)
            Furina.SPADE("SP_SRC_InsertAssyLineEff3")
            Return "Good"
        Catch ex As Exception
            Return ex.Message
        End Try
    ...
    Public Function InsertSRCAssyLineEffRow(DRID As Integer, TimePart As String, Customer As String, FGNo As String, Model As String, ModelCode As String, LotNo As String,
                                         GoodQty As Integer, Delivered As String, Replace As Integer, Scrap As Integer, Sample As String, OpTime As Integer, Hotto As Integer,
                                            Plan As Integer, Unplan As Integer, Cycle As Double) As String
        ...
        Try
            ...
            Furina.AddMySqlParameters("parUnPlanDownTime", Unplan)
            Furina.AddMySqlParameters("parCycleTime", Cycle)
            Furina.SPADE("SP_SRC_InsertAssyLineEffRow")
            Return "Good"
        Catch ex As Exception
            Return ex.Message
        End Try
    ...
    Public Function SelectAssyDuplicate(Model As String, DRID As Integer)
        Furina.AddMySqlParameters("parModel", Model)
        Furina.AddMySqlParameters("parDRID", DRID)
        Return Furina.SPSelect("SP_SRC_SelectAssyLineDuplicate")
    End Function


    Public Function EditSRCAssyLineEff(DRID As Integer, TimePart As String, OpTime As Integer, Hotto As Integer, Plan As Integer, Unplan As Integer, Cycle As Double,
                                         Customer As String, FGNo As String, Model As String, ModelCode As String, LotNo As String,
                                         GoodQty As Integer, Delivered As String, Replace As Integer, Scrap As Integer, Sample As String) As String

        Try
            Furina.AddMySqlParameters("parID", DRID)
            Furina.AddMySqlParameters("parTimePartition", TimePart)
            Furina.AddMySqlParameters("parOpTime", OpTime)
            Furina.AddMySqlParameters("parHotto", Hotto)
            Furina.AddMySqlParameters("parPlanDownTime", Plan)
            ...
            Furina.AddMySqlParameters("parAssyScrap", Scrap)
            Furina.AddMySqlParameters("parSample", Sample)
            Furina.SPADE("SP_SRC_UpdateAssyLineEff")
            Return "Good"
        Catch ex As Exception
            Return ex.Message
        End Try
    ...
    Public Function SelectSRCLotByTimev2(TableName As String, DRID As Integer, Time As String) As DataTable
        Furina.AddMySqlParameters("parDRID", DRID)
        Furina.AddMySqlParameters("parTime", Time)
        Return Furina.SPSelect("SP_SRC_SelectSRCLotByTime")
    End Function
    ...
    Public Function SelectAutoTaping() As DataTable
