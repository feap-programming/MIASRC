...
Public Class FrmShiftList
    ...
    Private Sub FrmShiftList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub readyGrid()
        ...
        Dim fldShiftName As New GridViewTextBoxColumn("SHIFT NAME")
        fldShiftName.FieldName = "fldShiftName"
        fldShiftName.Width = 160
    ...
    Private Sub bwLoadData_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bwLoadData.DoWork
        myData = Slipknot.dbSelect("SP_SelectAllShifts")
    End Sub
    ...
    Private Sub FrmShiftList_Shown(sender As Object, e As EventArgs) Handles Me.Shown
    ...
    Private Sub cbbAdd_Click(sender As Object, e As EventArgs) Handles cbbAdd.Click
        Dim check As String = Slipknot.checkPermission(currentUser.Item("fldUsername"), "fldMRShiftList")
        ...
        If check = "RW" Then
            ...
            If txtShiftName.Text.TrimStart.TrimEnd = String.Empty Then
                RadMessageBox.Show("Shift name cannot be empty", "WARNING", MessageBoxButtons.OK, RadMessageIcon.Exclamation)
                Exit Sub
            End If

            Slipknot.addParameter("parCode", txtCode.Text.TrimStart.TrimEnd)
            Slipknot.addParameter("parShiftName", txtShiftName.Text.TrimStart.TrimEnd)
            Slipknot.addParameter("parAddedBy", currentUser.Item("fldUsername"))
            If Slipknot.dbAED("SP_InsertShift") Then
                txtCode.Clear()
                txtShiftName.Clear()
                txtCode.Focus()
