...
Public Class FrmUOMList
    ...
    Private Sub FrmUOMList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub bwLoadData_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bwLoadData.DoWork
        myData = Slipknot.dbSelect("SP_SelectAllUOM")
    End Sub
    ...
    Private Sub FrmUOMList_Shown(sender As Object, e As EventArgs) Handles Me.Shown
    ...
    Private Sub cbbAdd_Click(sender As Object, e As EventArgs) Handles cbbAdd.Click
        ...
        Dim check As String = Slipknot.checkPermission(currentUser.Item("fldUsername"), "fldMRUOMList")

        If check = "RW" Then
            If txtUOM.Text.TrimStart.TrimEnd = String.Empty Then
                RadMessageBox.Show("UOM cannot be empty", "WARNING", MessageBoxButtons.OK, RadMessageIcon.Exclamation)

                Exit Sub
            End If

            Slipknot.addParameter("parUOM", txtUOM.Text.ToUpper.TrimStart.TrimEnd)
            Slipknot.addParameter("parAddedBy", currentUser.Item("fldUsername"))

            If Slipknot.dbAED("SP_InsertUOM") Then
