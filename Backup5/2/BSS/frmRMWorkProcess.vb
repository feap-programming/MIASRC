...
Public Class FrmRMWorkProcess
    ...
    Private Sub btnLotNo_Click(sender As Object, e As EventArgs) Handles btnLotNo.Click
        If gvData.Rows.Count > 0 Then
            ...
            ElseIf (txtPCode.Text = "P033") Then
    ...
    Private Sub cbSample_Click(sender As Object, e As EventArgs) Handles cbSample.Click
        If gvData.Rows.Count > 0 Then

            If Slipknot.IsFormOpen(FrmBSSSample) Then
                FrmBSSSample.Focus()
            Else
                FrmBSSSample.txtRMID.Text = gvData.CurrentRow.Cells("fldRMID").Value
                FrmBSSSample.Show(Me)
            End If
    ...
    Private Sub cbDuplicate_Click(sender As Object, e As EventArgs) Handles cbDuplicate.Click
        If Slipknot.IsFormOpen(FrmBSSCopyLotNo) Then
            FrmBSSCopyLotNo.Focus()
        Else
            FrmBSSCopyLotNo.txtMainID.Text = gvData.CurrentRow.Cells("fldMainID").Value
            FrmBSSCopyLotNo.Show(Me)
        End If
    End Sub

    Private Sub cbbEdit_Click(sender As Object, e As EventArgs) Handles cbbEdit.Click
        If Slipknot.IsFormOpen(FrmBSSEditRMWorkProcess) Then
            FrmBSSEditRMWorkProcess.Focus()
        Else
            FrmBSSEditRMWorkProcess.txtRMID.Text = gvData.CurrentRow.Cells("fldRMID").Value
            FrmBSSEditRMWorkProcess.txtTrayNo.Text = gvData.CurrentRow.Cells("fldTrayNo").Value
            FrmBSSEditRMWorkProcess.rtpTime.Value = gvData.CurrentRow.Cells("fldTime").Value.ToString
            FrmBSSEditRMWorkProcess.ShowDialog(Me)
        End If
    End Sub
End Class
