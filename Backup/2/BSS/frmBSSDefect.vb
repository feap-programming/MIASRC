...
Public Class FrmBSSDefect
    ...
    Private Sub cbbDelete_Click(sender As Object, e As EventArgs) Handles cbbDelete.Click
        If RadMessageBox.Show("WARNING. This operation is irreversible. Are you sure you want to remove this item?",
            ...
            Slipknot.addParameter("DID", gvData.CurrentRow.Cells("fldDID").Value.ToString)
            Slipknot.dbAED("SP_BSSDeleteDefectbyDID")
    ...
    Private Sub cbbEdit_Click(sender As Object, e As EventArgs) Handles cbbEdit.Click
        If (gvData.Rows.Count >= 1) Then
            If Slipknot.IsFormOpen(FrmBSSUpdateDefect) Then
                FrmBSSUpdateDefect.Focus()
            Else


                FrmBSSUpdateDefect.ShowDialog()
            End If
        Else
