...
Public Class frmProcessComponentList

    Private myData As DataTable
    Private Sub TblProcessComponentList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub readyGrid()
        ...
        fldDescription.FieldName = "fldName"
    ...
    Private Sub bwLoadData_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bwLoadData.DoWork
        ...
        myData = Slipknot.dbSelect("SP_SelectAllPComponentList")
    ...
    Private Sub TblProcessComponentList_Shown(sender As Object, e As EventArgs) Handles Me.Shown
    ...
    Private Sub cbbAdd_Click(sender As Object, e As EventArgs) Handles cbbAdd.Click
        ...
        Dim check As String = Slipknot.checkPermission(currentUser.Item("fldUsername"), "fldMRProcessComponentList")
        ...
        If check = "RW" Then
            ...
            If Slipknot.dbAED("SP_InsertPComponent") Then
    ...
    Private Sub bwDelete_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwDelete.DoWork
        ...
        Slipknot.dbAED("SP_DeletePComponents")
    End Sub
