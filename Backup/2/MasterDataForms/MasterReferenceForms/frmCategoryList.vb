...
Public Class frmCategoryList
    ...
    Private Sub bwLoadData_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bwLoadData.DoWork
        ...
        myData = Slipknot.dbSelect("SP_SelectAllCategory")
    ...
    Private Sub frmCategoryList_Shown(sender As Object, e As EventArgs) Handles Me.Shown
    ...
    Private Sub cbbAdd_Click(sender As Object, e As EventArgs) Handles cbbAdd.Click
        ...
        Dim check As String = Slipknot.checkPermission(currentUser.Item("fldUsername"), "fldMRCategoryList")

        If check = "RW" Then

            If txtCategory.Text.TrimStart.TrimEnd = String.Empty Then
                RadMessageBox.Show("Category should not be empty", "WARNING", MessageBoxButtons.OK, RadMessageIcon.Exclamation)

                Exit Sub
            End If

            Slipknot.addParameter("parCategory", txtCategory.Text.ToUpper.TrimStart.TrimEnd)
            Slipknot.addParameter("parAddedBy", currentUser.Item("fldUsername"))

            If Slipknot.dbAED("SP_InsertCategory") Then
    ...
    Private Sub bwDelete_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwDelete.DoWork
        ...
        Slipknot.dbAED("SP_DeleteCategory")
    End Sub
