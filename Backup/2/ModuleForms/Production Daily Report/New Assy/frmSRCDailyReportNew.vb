...
Public Class FrmSRCDailyReportNew
    Dim Furina As New Kurumi.DB("192.168.191.22", "dbMIA", "feap", "45|iF$")
    Dim ProgressText As String = ""
    Private Sub FrmSRCDailyReportNew_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        GetProcessName()
        ManpowerGrid()
        ReloadManpowerGrid()
        GetHourlyShiftTime()
...
#Region "Manpower"
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnMPSubmit.Click
        If ddProc.Text.Trim = "" Then
            MessageBox.Show("Please select process name")
        Else
            ...
            If btnMPSubmit.Text = "SAVE" Then
                ...
                MessageBox.Show(InsertSRCManpower(Mio.DRID, ddProc.Text, tbEmpName.Text, parQualify, parTransfer, parTrainee))
            ...
            Else
                ...
                MessageBox.Show(EditSRCManpower(Convert.ToInt32(lblEditID.Text), ddProc.Text, tbEmpName.Text, parQualify, parTransfer, parTrainee))
                btnMPSubmit.Text = "SAVE"
                btnMPCancel.Visible = False
    ...
    Private Sub rgvManpower_DoubleClick(sender As Object, e As EventArgs) Handles rgvManpower.DoubleClick
        ddProc.Text = rgvManpower.CurrentRow.Cells("fldProcessName").Value
        tbEmpName.Text = rgvManpower.CurrentRow.Cells("fldEmployee").Value
    ...
    Private Sub GetHourlyShiftTime()
        ...
        If Mio.Shift = "6AM-2PM(1st Shift)" Then
            ...
            While InitialHour < 8
                ...
                ddHQTime.Items.Add(InitialTime - 1 & ":00-" & InitialTime & ":00")
            End While
        ElseIf Mio.Shift = "6AM-6PM" Then
            Dim InitialTime As Integer = 6
            Dim InitialHour As Integer = 0
        ...
        ElseIf Mio.Shift = "6PM-6AM" Then
            ...
            While InitialHour < 12
                ...
                If InitialTime > 24 Then
                    ...
                    ddHQTime.Items.Add(After24Hrs - 1 & ":00-" & After24Hrs & ":00")
...
#Region "ASSY Line Eff"
    ...
    Private Sub btnALEAdd_Click(sender As Object, e As EventArgs) Handles btnALEAdd.Click
        rgvAssyLineEff.Rows.Add(tbALECustomer.Text, tbALEFGNo.Text, tbALEModelName.Text, tbALEModelCode.Text, tbALELotNo.Text, spnALEGoodQty.Value, spnALEReplace.Value, spnALEScrap.Value, spnALESample.Value)
    End Sub
        ...
        Else
            If Tohka.DeleteSrcTableByDRID("tblDailyReportAssyLineEff", Mio.DRID) = "Good" Then
                For rowcounter As Integer = 0 To Me.rgvAssyLineEff.Rows.Count - 1
                    ...
                    If Tohka.InsertSRCAssyLineEff(Mio.DRID, tbALETime.Text, tbALEOpTime.Text, spnALEHotto.Value, Convert.ToInt32(tbPlanned.Text), Convert.ToInt32(tbUnplanned.Text), Convert.ToDouble(tbCycle.Text), parCustomer, parFGNo, parModel, parModelCode, parLotNo, parGoodQty, "", parReplacement, parAssyScrap, parSample) = "Good" Then
    ...
    Private Sub GetLotNoTime()
        ...
        If Mio.Shift = "6AM-2PM(1st Shift)" Then
            ...
            While InitialHour < 8
                ...
                ddLotTime.Items.Add(InitialTime - 1 & ":00-" & InitialTime & ":00")
            End While
        ElseIf Mio.Shift = "6AM-6PM" Then
            Dim InitialTime As Integer = 6
            Dim InitialHour As Integer = 0
        ...
        ElseIf Mio.Shift = "6PM-6AM" Then
            ...
            While InitialHour < 12
                ...
                If InitialTime > 24 Then
                    After24Hrs = After24Hrs + 1
                    'gvData.Rows.Add(After24Hrs)
                    ddLotTime.Items.Add(After24Hrs - 1 & ":00-" & After24Hrs & ":00")
                    'gvData.CurrentRow.Cells("fldDeviation").Value = 0
                Else
                    'gvData.Rows.Add(InitialTime)
                    ddLotTime.Items.Add(InitialTime - 1 & ":00-" & InitialTime & ":00")
