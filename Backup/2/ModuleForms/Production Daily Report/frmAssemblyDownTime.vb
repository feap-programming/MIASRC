...
Public Class FrmAssemblyDownTime
    ...
    Private Sub ddShift_SelectedIndexChanged(sender As Object, e As Telerik.WinControls.UI.Data.PositionChangedEventArgs) Handles ddShift.SelectedIndexChanged
        ReloadTimeDD()
    End Sub
    Private Sub ReadyWeldingNo()
        Dim line1 As String() = {"108", "112"}
        Dim line2 As String() = {"116", "122"}
        Dim line3 As String() = {"118", "124"}
        Dim line4 As String() = {"114", "115"}
        ddWeldingNo.Items.Clear()

        If globalVariables.AssyDownTimeLine = "L1" Then
            ddWeldingNo.Items.AddRange(line1)
        ElseIf globalVariables.AssyDownTimeLine = "L2" Then
            ddWeldingNo.Items.AddRange(line2)
        ElseIf globalVariables.AssyDownTimeLine = "L3" Then
            ddWeldingNo.Items.AddRange(line3)
        ElseIf globalVariables.AssyDownTimeLine = "L4" Then
            ddWeldingNo.Items.AddRange(line4)
        End If
    ...
    Private Sub Updatereport()
        ...
        Try
            ...
            Maria.AddMySqlParameters("parPIC", ddPIC.Text)
            If globalVariables.DowntimeType = "ASSY" Then
    ...
    Private Sub gvData_CommandCellClick(sender As Object, e As GridViewCellEventArgs) Handles gvData.CommandCellClick
        ...
        ddPIC.Text = DTEdit.Rows(0).Item("fldPIC")
