...
Public Class frmInventoryTransfer

    Private dtpFrom As New RadDateTimePicker
    Private dtpTo As New RadDateTimePicker

    Private myData As DataTable
    Private Sub FrmIMInReceiving_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Slipknot.changeTheme(Me)

        cbhDateFrom.HostedItem = dtpFrom.DateTimePickerElement
        dtpFrom.Format = DateTimePickerFormat.Custom
        dtpFrom.CustomFormat = "MMM dd, yyyy"
        dtpFrom.Value = Today

        cbhDateTo.HostedItem = dtpTo.DateTimePickerElement
    ...
    Private Sub readyGrid()
        ...
        fldTo.FieldName = "whseTo"
        fldTo.Width = 210
        gvData.Columns.Add(fldTo)

        Dim fldTransferedQty As New GridViewDecimalColumn("TRANSFERRED QTY")
        fldTransferedQty.FieldName = "fldTransferedQty"
        fldTransferedQty.Width = 150
    ...
    Private Sub addEntry()
        ...
        If BulletForMyValentine.checkItemCodeIfExist(itemCode) Then
            ...
            If Slipknot.dbAED("SP_InsertInventoryTransfer") Then
    ...
    Private Sub bwLoadData_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bwLoadData.DoWork
        ...
        myData = Slipknot.dbSelect("SP_SelectAllInventoryTransfer")
    End Sub
    ...
    Private Sub FrmIMInReceiving_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        'mcbFrom.SelectedIndex = -1
        'mcbTo.SelectedIndex = -1
        mcbShift.SelectedIndex = -1
    ...
    Private Sub bwDelete_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwDelete.DoWork
        ...
        Slipknot.dbAED("SP_DeleteInventoryTransfer")
    End Sub
    ...
    Private Sub txtBarcode_KeyDown(sender As Object, e As KeyEventArgs) Handles txtBarcode.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            Dim check As String = Slipknot.checkPermission(frmBase.leUsername.Text, "fldModInventoryTransfer")
    ...
    Private Sub cbbEdit_Click(sender As Object, e As EventArgs) Handles cbbEdit.Click
        If Slipknot.IsFormOpen(FrmEditInventoryTransfer) Then
            FrmEditInventoryTransfer.Focus()
        Else
            If BulletForMyValentine.isRW("fldModInventoryTransfer") = False Then
                Slapshock.NoAccessToFunctionMessage()
            ...
            If gvData.SelectedRows.Count > 0 Then
                FrmEditInventoryTransfer.txtId.Text = Convert.ToString(gvData.CurrentRow.Cells("fldId").Value)
                FrmEditInventoryTransfer.Show(Me)
            End If
        End If
    End Sub
