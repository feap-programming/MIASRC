...
Public Class ucModelGroup
    ...
    Private Sub bwLoadData_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwLoadData.DoWork
        myData = Me.myDB.SPSelect("SP_P_SelectAllModelGroup")
    End Sub
    ...
    Private Sub bwOperation_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwOperation.DoWork
        ...
        Me.myDB.SPADE("SP_P_DeleteModelGroup")
    End Sub
    ...
    Private Sub cbbAdd_Click(sender As Object, e As EventArgs) Handles cbbAdd.Click
        ...
        If Me.drpLineCode.Text <> "NOT IN LINE" AndAlso
            Not String.IsNullOrWhiteSpace(Me.drpGroupCode.Text) Then
            ...
            Dim groupCode As String = Me.drpGroupCode.Text
            Dim modelCode As String = Me.drpModelCode.SelectedValue
            Dim partName As String = Me.txtPartName.Text
            ...
            If result = DialogResult.Yes Then
                ...
                Me.myDB.AddMySqlParameters("groupCode", Regex.Replace(Trim(groupCode), "\s+", ""))
                Me.myDB.AddMySqlParameters("modelCode", modelCode)
                Me.myDB.AddMySqlParameters("partName", Regex.Replace(Trim(partName), "\s+", " "))
                ...
                Me.myDB.SPADE("SP_P_InsertModelGroup")
                RadMessageBox.Show(Me, "Model Group successfully added.", "Success", MessageBoxButtons.OK, RadMessageIcon.Info)
            End If

        Else

            RadMessageBox.Show(Me, "Please select SRC/BSS line and model group.", "Warning", MessageBoxButtons.OK, RadMessageIcon.Exclamation)
    ...
    Private Sub cbbEdit_Click(sender As Object, e As EventArgs) Handles cbbEdit.Click
        ...
        Try
            Dim editForm As New FrmEditModelGroup
    ...
    Private Sub cbCopy_Click(sender As Object, e As EventArgs) Handles cbCopy.Click
        Dim editForm As New FrmCopyToModelGroup
    ...
    Private Sub cbImport_Click(sender As Object, e As EventArgs) Handles cbImport.Click
        Dim editForm As New FrmImportModelGroup
        editForm.ShowDialog(Me)
    End Sub
    ...
    Private Sub cbPreview_Click(sender As Object, e As EventArgs) Handles cbPreview.Click
        ...
        previewForm.ShowDialog("Model Group Preview")
    End Sub
    ...
    Private Sub SetUpColumns(gridView As RadGridView)
        ...
        yearDesc.GroupNames.Add("fldYear", ListSortDirection.Ascending)
        ...
        Dim groupCodeDesc As New GroupDescriptor()
        groupCodeDesc.GroupNames.Add("fldGroupCode", ListSortDirection.Ascending)
        gridView.GroupDescriptors.Add(groupCodeDesc)
